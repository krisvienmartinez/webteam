...
function populateTable() {
    ...
    userListData = data;
        ...
        $.each(data, function(){
            ...
            tableContent += '<td>' + this.plateno + '</td>';
...
function addUser(event,name,age, callback) {
    ...
    if(errorCount === 0) {
        ...
        var newUser = {
            ...
            'plateno': $('#addUser fieldset input#inputUserPlateno').val(),
...
function searchUser(event) {
    ...
    // var thisSearchdrive = $('#searchUser input');
    // Retrieve username from link rel attribute
    // var thisUserName = $(this).attr('rel');
    ...
    // Get Index of object based on id value
    var arrayPosition = userListData.map(function(arrayItem) { return arrayItem.username; }).indexOf(searchvariable);
    // Get our User Object
    var thisUserObject = userListData[arrayPosition];
    ...
    // todo:
    // 1. do an ajax call (post to /user-search)
   // 2. display data     
};
